...
"[project]/src/lib/walletManager.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$polkadot$2f$extension$2d$dapp$2f$bundle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@polkadot/extension-dapp/bundle.js [app-client] (ecmascript) <locals>");
"use client";
;
async function connectWallet(chain) {
    if (chain.toLowerCase() === "ethereum") {
        ...
        var _accounts_;
        return (_accounts_ = accounts[0]) !== null && _accounts_ !== void 0 ? _accounts_ : null;
    }
    if (chain.toLowerCase() === "polkadot") {
        const extensions = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$polkadot$2f$extension$2d$dapp$2f$bundle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["web3Enable"])("Swap");
        if (!extensions.length) throw new Error("Polkadot.js extension not available");
        const accounts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$polkadot$2f$extension$2d$dapp$2f$bundle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["web3Accounts"])();
...
async function signMessage(chain, message) {
    ...
    if (chain.toLowerCase() === "polkadot") {
        const extensions = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$polkadot$2f$extension$2d$dapp$2f$bundle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["web3Enable"])("YourApp");
        if (!extensions.length) throw new Error("Polkadot.js extension not available");
        const accounts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$polkadot$2f$extension$2d$dapp$2f$bundle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["web3Accounts"])();
        if (!accounts.length) throw new Error("No Polkadot accounts found");
        const injector = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$polkadot$2f$extension$2d$dapp$2f$bundle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["web3FromSource"])(accounts[0].meta.source);
    ...
    throw new Error("Signing not supported for chain: ".concat(chain));
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$walletManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/walletManager.ts [app-client] (ecmascript)");
;
...
function SwapWidget() {
    ...
    const handleSwap = async ()=>{
        const fromAddress = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$walletManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["connectWallet"])(sourceChain);
        if (!fromAddress) {
        ...
        const message = "Swap ".concat(sourceAmount, " ").concat(sourceToken, " from ").concat(sourceChain, " to ").concat(destToken, " on ").concat(destChain);
        try {
            const signature = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$walletManager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signMessage"])(sourceChain, message);
            console.log("Signature:", signature);
            const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$orderApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["orderSwap"])(sourceChain, sourceToken, sourceAmount, destChain, destToken, signature);
            if (success) {
...
//# sourceMappingURL=src_439a8058._.js.map