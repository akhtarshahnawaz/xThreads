...
async function connectWallet(chain) {
    ...
    if (chain.toLowerCase() === "polkadot") {
        const { web3Enable, web3Accounts } = await __turbopack_context__.r("[project]/node_modules/@polkadot/extension-dapp/index.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
...
async function signMessage(chain, message) {
    ...
    if (chain.toLowerCase() === "polkadot") {
        const { web3Enable, web3Accounts, web3FromSource } = await __turbopack_context__.r("[project]/node_modules/@polkadot/extension-dapp/index.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
...
//# sourceMappingURL=src_583236ea._.js.map